...
class Cosmology_EDE:
    def __init__(self, Omega_c, Omega_b, h, n_s, sigma8, Omega_k, eme, a_st, gamma=None):
        """
        Cosmology object, stores primary and derived cosmological parameters.
    ...
    def tree_unflatten(cls, aux_data, children):
        # Retrieve base parameters
        Omega_c, Omega_b, h, n_s, sigma8, Omega_k, eme, a_st = children[:8]
        children = list(children[8:]).reverse()
